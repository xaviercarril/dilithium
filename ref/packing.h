...
void pack_sig(uint8_t sig[CRYPTO_BYTES], const uint8_t c[CBYTES], const polyvecl *z, const polyveck *h);
...
int unpack_sig(uint8_t c[CBYTES], polyvecl *z, polyveck *h, const uint8_t sig[CRYPTO_BYTES]);
